          ...
          <div className="center">
            <div className="Invite">
              ...
              <p className="Invite__description">
                <FormattedMessage
                  id="invite_info"
                  defaultMessage="Onboard new users on SteemClassifieds.com today using the link below and get 10% of their rewards for 30 days."
                />
              </p>
              ...
              <div className="Invite__social">
                ...
                <TwitterShare
                  ...
                  text={intl.formatMessage(
                    {
                      id: 'invite_share',
                      defaultMessage: 'Join me today on SteemClassifieds.com and get rewarded to Buy and Sell with STEEM {link}',
                    },
                    {
                      link: '',
                    },
                ...
                <EmailShare
                  ...
                  text={intl.formatMessage(
                    {
                      id: 'invite_share',
                      defaultMessage: 'Join me today on SteemClassifieds.com and get rewarded to post for selling {link}',
                    },
                    {
